...
--
-- Хост: localhost:3306
-- Время создания: Апр 04 2022 г., 21:01
...
--
-- Структура таблицы `integrators_categories`
--
...
--
-- Структура таблицы `integrators_products_items`
--
...
--
-- Структура таблицы `integrators_products_items_lang`
--
...
--
-- Структура таблицы `integrators_regions`
--
...
--
-- Структура таблицы `integrator_category`
--
...
--
-- Структура таблицы `integrator_category_lang`
--
...
--
-- Структура таблицы `integrator_langs`
--
...
--
-- Индексы таблицы `integrators_categories`
--
...
--
-- Индексы таблицы `integrators_products`
--
...
--
-- Индексы таблицы `integrators_products_items`
--
...
--
-- Индексы таблицы `integrators_products_items_lang`
--
...
--
-- Индексы таблицы `integrators_props`
--
...
--
-- Индексы таблицы `integrators_regions`
--
...
--
-- Индексы таблицы `integrator_category`
--
ALTER TABLE `integrator_category`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `integrator_category_lang`
--
...
--
-- Индексы таблицы `integrator_contacts`
--
...
--
-- Индексы таблицы `integrator_lang`
--
ALTER TABLE `integrator_lang`
  ...
  ADD KEY `fk_integrator_lang_lang1_idx` (`lang_id`);

--
-- Индексы таблицы `integrator_langs`
--
...
--
-- Индексы таблицы `integrator_prop`
--
ALTER TABLE `integrator_prop`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `integrator_prop_lang`
--
...
--
-- Индексы таблицы `products_industries`
--
...
--
-- Индексы таблицы `products_props`
--
...
--
-- Индексы таблицы `products_regions`
--
...
--
-- Индексы таблицы `product_tarif_items`
--
...
--
-- Индексы таблицы `product_tarif_lang`
--
...
--
-- Индексы таблицы `props_questions`
--
...
--
-- Индексы таблицы `prop_type`
--
ALTER TABLE `prop_type`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `prop_type_lang`
--
...
--
-- AUTO_INCREMENT для таблицы `industry_lang`
--
ALTER TABLE `industry_lang`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `integrator`
--
ALTER TABLE `integrator`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `integrators_products`
--
ALTER TABLE `integrators_products`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `integrators_products_items`
--
ALTER TABLE `integrators_products_items`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `integrators_products_items_lang`
--
ALTER TABLE `integrators_products_items_lang`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `integrator_category`
--
ALTER TABLE `integrator_category`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `integrator_category_lang`
--
ALTER TABLE `integrator_category_lang`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `integrator_contacts`
--
ALTER TABLE `integrator_contacts`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `integrator_lang`
--
ALTER TABLE `integrator_lang`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `integrator_langs`
--
ALTER TABLE `integrator_langs`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `integrator_prop`
--
ALTER TABLE `integrator_prop`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `integrator_prop_lang`
--
ALTER TABLE `integrator_prop_lang`
...
--
-- AUTO_INCREMENT для таблицы `product_tarif`
--
ALTER TABLE `product_tarif`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `product_tarif_items`
--
ALTER TABLE `product_tarif_items`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `product_tarif_lang`
--
ALTER TABLE `product_tarif_lang`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `prop`
--
ALTER TABLE `prop`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `prop_lang`
--
ALTER TABLE `prop_lang`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `prop_type`
--
ALTER TABLE `prop_type`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `prop_type_lang`
--
ALTER TABLE `prop_type_lang`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
...
--
-- Ограничения внешнего ключа таблицы `integrators_categories`
--
ALTER TABLE `integrators_categories`
...
--
-- Ограничения внешнего ключа таблицы `integrators_products_items`
--
ALTER TABLE `integrators_products_items`
...
--
-- Ограничения внешнего ключа таблицы `integrators_products_items_lang`
--
ALTER TABLE `integrators_products_items_lang`
...
--
-- Ограничения внешнего ключа таблицы `integrators_regions`
--
ALTER TABLE `integrators_regions`
...
--
-- Ограничения внешнего ключа таблицы `integrator_category_lang`
--
ALTER TABLE `integrator_category_lang`
...
ALTER TABLE `integrator_lang`
  ...
  ADD CONSTRAINT `fk_integrator_lang_lang1` FOREIGN KEY (`lang_id`) REFERENCES `lang` (`id`);

--
-- Ограничения внешнего ключа таблицы `integrator_langs`
--
ALTER TABLE `integrator_langs`
