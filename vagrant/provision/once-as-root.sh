...
apt-get install -y php7.4-curl php7.4-cli php7.4-intl php7.4-mysqlnd php7.4-gd php7.4-fpm php7.4-mbstring php7.4-xml unzip nginx mysql-server php.xdebug
...
mysql -uroot <<< "CREATE DATABASE iwl;"
mysql -uroot <<< "ALTER DATABASE iwl CHARACTER SET utf8 COLLATE utf8_general_ci;"
mysql -uroot <<< "CREATE DATABASE iwl_test;"
mysql -uroot <<< "AFTER DATABASE iwl_test CHARACTER SET utf8 COLLATE utf8_general_ci;"
echo "Done!"

info "Install composer"
curl -sS https://getcomposer.org/installer | php -- --install-dir=/usr/local/bin --filename=composer

mysql -uroot iwl < /app/db/db.sql
